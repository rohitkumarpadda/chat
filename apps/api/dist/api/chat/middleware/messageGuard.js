...
exports.messageGuard = void 0;
var models_1 = require("../models");
/**
 * Middleware to check if the user has access to the message
 * Only the sender of the message can edit or delete it
 */
var messageGuard = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var messageId, message, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (!messageId) {
                    return [2 /*return*/, res.status(400).json({ message: "Message ID is required" })];
                }
                return [4 /*yield*/, models_1.MessageModel.findById(messageId)];
            case 1:
                message = _a.sent();
                if (!message) {
...
exports.messageGuard = messageGuard;
