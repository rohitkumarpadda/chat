...
var user_model_1 = __importDefault(require("~/api/user/user.model"));
var jwt_1 = require("~/utils/jwt");
var password_1 = require("~/utils/password");
var controller = {
    register: function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, username, name, password, email, exists, emailExists, user, e_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 4, , 5]);
                        _a = req.body, username = _a.username, name = _a.name, password = _a.password, email = _a.email;
                    ...
                    case 3:
                        ...
                        (0, jwt_1.issueJWT)({ user: user, res: res });
                        res.status(201).json({
    ...
    login: function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, username, password, user, isMatch, e_2;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 4, , 5]);
